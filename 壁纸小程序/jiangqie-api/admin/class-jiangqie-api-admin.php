        ...
        $fields[] = array(
            ...
            'fields' => array(
				...
				array(
				    ...
				    'title'       => '分享标题',
				    'class'       => 'text-class',
				    'description' => '小程序 分享标题',
				    'attributes'    => array(
				        'placeholder' => '请输入小程序 分享标题',
				        'data-test'   => 'test',
				    ),
				    // 'sanitize'    => array($this, 'test_sanitize_callback'),
				),
		...
		$fields[] = array(
		    ...
		    'fields' => array(
					...
					array(
					    ...
					    'type'        => 'text',
					    'title'       => '广告设置',
						'before'      => '广告标识：1.banner、2.视频、3.格子、4.原生A、5.原生B',
						'after'       => '广告位置：1.首页信息流、2.分类页顶部、3.底部、4.分类列表页信息流、5.热榜页信息流、6.我的页底部、7.我的收藏/点赞/浏览顶部、8.关于我们页底部广告',
					    'class'       => 'text-class',
					    'description' => '示例：4,5,1,3',
					    'attributes'    => array(
					        'placeholder' => '按照示例输入广告设置',
					        'data-test'   => 'test',
					    ),
					    // 'sanitize'    => array($this, 'test_sanitize_callback'),
					),
